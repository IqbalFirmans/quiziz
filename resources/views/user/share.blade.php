                ...
                <div class="feed p-2">
                    ...
                    @foreach ($data as $posts)
                        <div class="bg-white border mt-2">
                            <div>
                                <div class="d-flex flex-row justify-content-between align-items-center p-2 border-bottom">
                                    <div class="d-flex flex-row align-items-center feed-text px-2">
                                            ...
                                            <img class="rounded-circle" src="{{ asset('storage/' . $posts->user->photo) }}"
                                                height="45" width="45">
                            ...
                            <div class="p-2 px-3"><span>{{ $posts->description }}</span></div>
                                                                    ...
                                                                    <div class="flex-grow-1 flex-shrink-1">
                                                                        ...
                                                                        <div class="collapse" id="reply_comments_section">
                                                                            <form action="" method="post"
                                                                                class="mt-2">
                                                                                @csrf
                                                                                <textarea name="komentar" id="komentar" placeholder="Komentar..." class="form-control" cols="15"
                                                                                    rows="5"></textarea>
                                                                                <button type="submit"
